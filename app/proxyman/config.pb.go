...
// HTTPQueryB64Config configures the httpqueryb64 sniffer: it recovers the
// real target host from an HTTP request whose query string carries the
// original URL in base64. Sniffing applies only to connections whose
// destination matches one of `dst`.
type HTTPQueryB64Config struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Query-parameter name carrying the encoded URL. Empty means the value
	// directly follows the '?' (the first unnamed parameter: GET /?<base64>).
	Param string `protobuf:"bytes,1,opt,name=param,proto3" json:"param,omitempty"`
	// Gateway addresses ("ip:port") the sniffer is enabled for.
	Dst []string `protobuf:"bytes,2,rep,name=dst,proto3" json:"dst,omitempty"`
	// Base64 alphabet: "auto" (default), "standard", "urlsafe".
	Variant       string `protobuf:"bytes,3,opt,name=variant,proto3" json:"variant,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *HTTPQueryB64Config) Reset() {
	*x = HTTPQueryB64Config{}
	mi := &file_app_proxyman_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *HTTPQueryB64Config) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HTTPQueryB64Config) ProtoMessage() {}

func (x *HTTPQueryB64Config) ProtoReflect() protoreflect.Message {
	mi := &file_app_proxyman_config_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HTTPQueryB64Config.ProtoReflect.Descriptor instead.
func (*HTTPQueryB64Config) Descriptor() ([]byte, []int) {
	return file_app_proxyman_config_proto_rawDescGZIP(), []int{1}
}

func (x *HTTPQueryB64Config) GetParam() string {
	if x != nil {
		return x.Param
	}
	return ""
...
func (x *HTTPQueryB64Config) GetDst() []string {
	if x != nil {
		return x.Dst
	}
	return nil
...
func (x *HTTPQueryB64Config) GetVariant() string {
	if x != nil {
		return x.Variant
	}
	return ""
...
type SniffingConfig struct {
	...
	// Settings for the httpqueryb64 sniffer.
	HttpQueryB64  *HTTPQueryB64Config `protobuf:"bytes,7,opt,name=http_query_b64,json=httpQueryB64,proto3" json:"http_query_b64,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SniffingConfig) GetHttpQueryB64() *HTTPQueryB64Config {
	if x != nil {
		return x.HttpQueryB64
	}
	return nil
}
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\rInboundConfig\"V\n" +
	"\x12HTTPQueryB64Config\x12\x14\n" +
	"\x05param\x18\x01 \x01(\tR\x05param\x12\x10\n" +
	"\x03dst\x18\x02 \x03(\tR\x03dst\x12\x18\n" +
	"\avariant\x18\x03 \x01(\tR\avariant\"\x99\x02\n" +
	...
	"\n" +
	"route_only\x18\x05 \x01(\bR\trouteOnly\x12K\n" +
	"\x0ehttp_query_b64\x18\a \x01(\v2%.xray.app.proxyman.HTTPQueryB64ConfigR\fhttpQueryB64\"\xe5\x02\n" +
...
var file_app_proxyman_config_proto_goTypes = []any{
	...
	(*HTTPQueryB64Config)(nil),    // 1: xray.app.proxyman.HTTPQueryB64Config
...
var file_app_proxyman_config_proto_depIdxs = []int32{
	1,  // 0: xray.app.proxyman.SniffingConfig.http_query_b64:type_name -> xray.app.proxyman.HTTPQueryB64Config
