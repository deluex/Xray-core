...
// AffinityConfig enables the domain→outbound affinity table: for
// connections whose destination matches one of `special_dst`, the outbound
// recorded when the domain was first routed is reused, bypassing rule
// matching entirely. Unmatched connections fall through to normal rules.
type AffinityConfig struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Enabled bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Gateway addresses ("ip:port") the affinity lookup applies to.
	SpecialDst []string `protobuf:"bytes,2,rep,name=special_dst,json=specialDst,proto3" json:"special_dst,omitempty"`
	// Entry lifetime in seconds; refreshed on every recorded connection.
	// 0 means 600 (10 minutes).
	TtlSeconds int64 `protobuf:"varint,3,opt,name=ttl_seconds,json=ttlSeconds,proto3" json:"ttl_seconds,omitempty"`
	// Maximum number of remembered domains (LRU eviction). 0 means 65536.
...
func (x *AffinityConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *AffinityConfig) GetSpecialDst() []string {
	if x != nil {
		return x.SpecialDst
	}
	return nil
...
func (x *AffinityConfig) GetTtlSeconds() int64 {
	if x != nil {
		return x.TtlSeconds
	}
	return 0
...
func (x *AffinityConfig) GetMaxEntries() int64 {
	if x != nil {
		return x.MaxEntries
	}
	return 0
...
type Config struct {
	...
	Affinity       *AffinityConfig        `protobuf:"bytes,4,opt,name=affinity,proto3" json:"affinity,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Config) GetAffinity() *AffinityConfig {
	if x != nil {
		return x.Affinity
	}
	return nil
...
const file_app_router_config_proto_rawDesc = "" +
	...
	"\ttolerance\x18\x06 \x01(\x02R\ttolerance\"\x8d\x01\n" +
	"\x0eAffinityConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1f\n" +
	"\vspecial_dst\x18\x02 \x03(\tR\n" +
	"specialDst\x12\x1f\n" +
	...
	"\x0ebalancing_rule\x18\x03 \x03(\v2\x1e.xray.app.router.BalancingRuleR\rbalancingRule\x12;\n" +
	"\baffinity\x18\x04 \x01(\v2\x1f.xray.app.router.AffinityConfigR\baffinity\"<\n" +
...
var file_app_router_config_proto_goTypes = []any{
	...
	(*AffinityConfig)(nil),          // 13: xray.app.router.AffinityConfig
...
var file_app_router_config_proto_depIdxs = []int32{
	...
	13, // 23: xray.app.router.Config.affinity:type_name -> xray.app.router.AffinityConfig
